namespace TestTask.Minesweeper.Domain.Processors
{
	...
	{
		/// <summary>
		/// Processes <paramref name="turns"/>, which were made since <paramref name="lastSnapshot"/> and creates <paramref name="newSnapshot"/>.
		/// </summary>
		...
		Enums.TurnResult Process(IOrderedEnumerable<Entities.Turn> turns, Entities.Snapshot lastSnapshot, out Entities.Snapshot newSnapshot);
	}
}
